	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>DERMAFRIK | Détails - Actualités</title>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="{{route('home')}}">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="{{route('blog')}}">Blog </a> <span class="lnr lnr-arrow-right"></span> <a href="#"> Blog Details Page</a></p>
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8 posts-list">
							...
							<a href="{{ url()->previous() }}" class="primary-btn pull-left"><i class="fa fa-arrow-left"></i> Retour </a>
