					...
					<div class="row">
						...
						<div class="col-lg-8">
							...
							<div class="section-top-border">
								<h3 class="mb-30">{{$nb}} Résultat(s) trouvé(s) </h3>

								@if($nb == 0)

									<div class="alert alert-danger alert-dismissible fade show" role="alert">
										<strong>Error!</strong> No <a href="#" class="alert-link">Dermatologist</a>  found for your query. Please try to search again! 
								...
								<div class="progress-table-wrap">
									<div class="progress-table">
										<div class="table-head">
											...
											<div class="percentage">Nom et Prénom(s)</div>
											<div class="country">Email</div>
											<div class="visit">Téléphone</div>
											<div class="visit">Pays</div>
										...
										<div class="table-row">
											...
											<div class="percentage"> <img src="{{url('/storage/profile_images/'.$doctor->profile_picture ) }}" alt="flag" width="20%">{{$doctor->title}}. {{$doctor->name}} {{$doctor->firstname}}</div>
											<div class="country">{{$doctor->email}}</div>
											<div class="visit">{{$doctor->phone_number}}</div>
											<div class="visit">{{$doctor->country}}</div>
											<div class="percentage">
												<a href="{{route('doctor.show', $doctor->id)}}" class="genric-btn info-border circle">Voir Plus</a>
												<!--<div class="progress">
